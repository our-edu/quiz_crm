...
from quiz_crm.quiz_crm.utils import get_country_code, get_quiz_route
...
def on_login(login_manager):
	...
	if default_app == "quiz_crm":
		frappe.local.response["home_page"] = get_quiz_route()
