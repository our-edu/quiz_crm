...
from quiz_crm.quiz_crm.utils import guest_access_allowed
...
def has_permission(doc, ptype="read", user=None):
	...
	is_enrolled = frappe.db.exists("Program Member", {"parent": doc.name, "member": user})
	if is_enrolled:
		return True

	is_program_published = frappe.db.get_value("Program", doc.name, "published")
