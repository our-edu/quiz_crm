...
const outline = createResource({
	url: 'quiz_crm.quiz_crm.utils.get_course_outline',
...
const deleteLesson = createResource({
	url: 'quiz_crm.quiz_crm.api.delete_lesson',
	makeParams(values) {
		return {
...
const updateLessonIndex = createResource({
	url: 'quiz_crm.quiz_crm.api.update_lesson_index',
	makeParams(values) {
		return {
			lesson: values.lesson,
...
const updateChapterIndex = createResource({
	url: 'quiz_crm.quiz_crm.api.update_chapter_index',
	makeParams(values) {
		return {
			chapter: values.chapter,
...
const deleteChapter = createResource({
	url: 'quiz_crm.quiz_crm.api.delete_chapter',
	makeParams(values) {
		return {
			chapter: values.chapter,
		}
