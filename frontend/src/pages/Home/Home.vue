...
const myLiveClasses = createResource({
	url: 'quiz_crm.quiz_crm.api.get_my_live_classes',
	auto: !isAdmin.value ? true : false,
})

const adminLiveClasses = createResource({
	url: 'quiz_crm.quiz_crm.api.get_admin_live_classes',
	auto: isAdmin.value ? true : false,
})

const adminEvals = createResource({
	url: 'quiz_crm.quiz_crm.api.get_admin_evals',
	auto: isAdmin.value ? true : false,
})

const streakInfo = createResource({
	url: 'quiz_crm.quiz_crm.api.get_streak_info',
	auto: true,
})
