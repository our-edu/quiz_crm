...
const lesson = createResource({
	url: 'quiz_crm.quiz_crm.utils.get_lesson',
	makeParams(values) {
		return {
...
const progress = createResource({
	url: 'quiz_crm.quiz_crm.doctype.course_lesson.course_lesson.save_progress',
	makeParams() {
		return {
			lesson: lesson.data.name,
			course: props.courseName,
...
const trackVideoWatchDuration = () => {
	...
	call('quiz_crm.quiz_crm.api.track_video_watch_duration', {
		lesson: lesson.data.name,
		videos: videoDetails,
	})
}
